  ...
  return (
    <form className="animate-in fade-in slide-in-from-bottom-4 duration-500" onSubmit={(e) => e.preventDefault()}>
      <div className="flex items-center gap-4 mb-10">
        ...
        <h2 className="text-2xl md:text-3xl font-medium text-white">Hablemos por mensaje</h2>
      </div>
      ...
      <div className="bg-[#1A1D21] rounded-xl p-4 flex items-center gap-4">
        ...
        <p className="text-sm text-white/80 font-medium">
          <span className="text-color-terciario font-bold">Hey, somos el Equipo Rukma,</span> revisaremos tu mensaje y nos pondremos en contacto contigo a la brevedad posible.
        </p>
      </div>
    </form>
  );
